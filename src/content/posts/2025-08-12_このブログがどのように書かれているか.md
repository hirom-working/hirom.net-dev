...
まずはObsidianに記事のネタになることをざざっと書きます。

それをベースに、Gemini-cliに叩き台を書いてもらって、それをいったん自分で書き直して、再度Gemini-cliに校正をしてもらっています。

Geminiさんは優秀ですけど、そのままブログの記事を校正させるととても気持ちの悪い文章を生成するので、調教が必要です。

僕はTwitterの過去ログを丸ごと読ませて、なるべく僕が書いたものとかけ離れたものにならないように"いい感じに"GEMINI.mdを出力して使っています。まだまだ調教が足りないですが、そういった部分も含めて新しい試みとして楽しんでやっています。