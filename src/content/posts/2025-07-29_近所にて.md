...
![Pixel art of a tree](./showing-off-blog-features/PixelatedGreenTreeSide.png 'Pixel art renders poorly without proper CSS')
...
![Pixel art of a tree #pixelated](./showing-off-blog-features/PixelatedGreenTreeSide.png 'But adding #pixelated to the end of the alt string fixes this')
